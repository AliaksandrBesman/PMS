...
public class FragmentItem extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final Animation animRotate = AnimationUtils.loadAnimation(this.getContext(), R.anim.scale_button1);
        getPhoto.startAnimation(animRotate);
        takePhoto.startAnimation(animRotate);
...
//            }
    ...
    public void clickPhoto(View view) {
        final Animation animScale = AnimationUtils.loadAnimation(this.getContext(), R.anim.scale_button);
